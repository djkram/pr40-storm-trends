 ...
 * Configuración:
 * 
 *  1 spout en 2 tareas, con lo que se generan el doble de tweets
...
public class Main02All {
    ...
    public static void main(String[] args) {
        ...
        builder.setSpout("utmSource", new FakeTweetSpout(), 2); // hint: 2 executors (threads) 
